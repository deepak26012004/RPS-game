function playGame(playerChoice) //We create a function//
{
    ...
    const computerChoice = userChoice[Math.floor(Math.random() * 3)]; //We get the random choice from computer //
    let result;
    ...
    } else if ((playerChoice === 'Rock' && computerChoice == 'scissors') || //Rock > scissor = Rock winner(Rock brake the scissors)//
